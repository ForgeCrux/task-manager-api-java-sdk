...
|------------- | ------------- | -------------|
| [**addTaskComment**](TasksApi.md#addTaskComment) | **POST** /tasks/{taskId}/comments | Add a comment to a task |
...
| [**getTaskById**](TasksApi.md#getTaskById) | **GET** /tasks/{taskId} | Get a task by ID |
| [**listTasks**](TasksApi.md#listTasks) | **GET** /tasks | List all tasks |
| [**updateTask**](TasksApi.md#updateTask) | **PUT** /tasks/{taskId} | Update an existing task |
